...
exec_command "ssh admnode \"echo $IP_ADDRESS $NODE_NAME >> /etc/hosts\""
...
exec_command "ssh -t $ADMNODE_NAME \"systemctl restart gmetad\""
exec_command "ssh -t $ADMNODE_NAME \"systemctl restart gmond\""
exec_command "ssh -t $ADMNODE_NAME \"systemctl restart httpd\""
