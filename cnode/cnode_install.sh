...
exec_command "yum install https://dl.fedoraproject.org/pub/epel/7/x86_64/l/libconfuse-2.7-7.el7.x86_64.rpm -y"
exec_command "yum install https://dl.fedoraproject.org/pub/epel/7/x86_64/l/libconfuse-devel-2.7-7.el7.x86_64.rpm -y"
...
exec_command "echo \"  host = 6.buhpc.com\" >> /etc/ganglia/gmond.conf"
exec_command "echo \"  port = 8649\" >> /etc/ganglia/gmond.conf"
exec_command "echo \"  ttl = 1\" >> /etc/ganglia/gmond.conf"
exec_command "echo \"  }\" >> /etc/ganglia/gmond.conf"
exec_command "scp $ADMNODE_NAME:/etc/ganglia/gmond.conf /etc/ganglia"
exec_command "ssh $ADMNODE_NAME:systemctl restart gmond"
...
echoBold "ATENCION: Reinicie el nodo con el comando reboot para que los cambios surjan efecto"
